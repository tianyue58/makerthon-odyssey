          ...
          <GridContainer>
            <GridItem2>
              <img className="planet" src={tip1} alt="img" onClick={() =>
                  navigate("/TalkingState", { state: "other_before1" })
                }/>
            </GridItem2>
            <GridItem2>
              <img className="planet" src={tip2} alt="img" onClick={() =>
                  navigate("/TalkingState", { state: "other_before2" })
                }/>
              
            </GridItem2>
            <GridItem2>
              <img className="planet" src={tip3} alt="img" onClick={() =>
                  navigate("/TalkingState", { state: "other_before3" })
                }/>
            </GridItem2>
